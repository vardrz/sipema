                ...
                <div class="row">
                    <div class="col">
                        <div class="p-5">
                            ...
                            <form class="user" action="<?= base_url('register/addUser') ?>" method="post">
                                <div class="form-group">
                                    <input type="number" name="nik" class="form-control form-control-user" id="exampleInputEmail"
                                        placeholder="NIK">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="telp" class="form-control form-control-user" id="exampleInputEmail"
